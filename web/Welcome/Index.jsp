<%-- 
    Document   : Index
    Created on : Mar 7, 2017, 7:52:32 PM
    Author     : vikrant
--%>
...
<html>
  <head>
    ...
    <link rel="stylesheet" href="Welcome/css/ionicons.min.css" />
  ...
  <body>
    <nav id="topNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#first"><i class="ion-ios-analytics-outline"></i> Attendance</a>
            </div>
    ...
    <header id="first">
        <div class="header-content">
            <div class="inner">
                <h1 class="cursive">Welcome to Attendance</h1>
                <h4>Please choose the options below</h4>
                <hr>
                <a href="Dashboard/Index.jsp" class="btn btn-primary btn-xl">Dashboard</a> &nbsp; <a href="../Profile/Index.jsp" class="btn btn-primary btn-xl page-scroll">User Login</a>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row no-gutter">
                <div class="col-lg-4 col-sm-6">
                    <a href="#galleryModal" class="gallery-box" data-toggle="modal" data-src="Welcome/assets/deer.jpg">
                        <img src="Welcome/assets/deer.jpg" class="img-responsive" alt="Image 1">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="#galleryModal" class="gallery-box" data-toggle="modal" data-src="Welcome/assets/beach.jpg">
                        <img src="Welcome/assets/beach.jpg" class="img-responsive" alt="Image 2">
                        <div class="gallery-box-caption">
                            <div class="gallery-box-content">
                                <div>
                                    <i class="icon-lg ion-ios-search"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="#galleryModal" class="gallery-box" data-toggle="modal" data-src="Welcome/assets/lake.jpg">
                        <img src="Welcome/assets/lake.jpg" class="img-responsive" alt="Image 3">
                        <div class="gallery-box-caption">
                            <div class="gallery-box-content">
                                <div>
                                    <i class="icon-lg ion-ios-search"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="#galleryModal" class="gallery-box" data-toggle="modal" data-src="Welcome/assets/bike.jpg">
                        <img src="Welcome/assets/bike.jpg" class="img-responsive" alt="Image 4">
                        <div class="gallery-box-caption">
                            <div class="gallery-box-content">
                                <div>
                                    <i class="icon-lg ion-ios-search"></i>
				...
				<div class="clearfix hidden-lg"> </div>
                <div class="col-lg-4 col-sm-6">
                    <a href="#galleryModal" class="gallery-box" data-toggle="modal" data-src="Welcome/assets/city.jpg">
                        <img src="Welcome/assets/city.jpg" class="img-responsive" alt="Image 5">
                        <div class="gallery-box-caption">
                            <div class="gallery-box-content">
                                <div>
                                    <i class="icon-lg ion-ios-search"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="#galleryModal" class="gallery-box" data-toggle="modal" data-src="Welcome/assets/colors.jpg">
                        <img src="Welcome/assets/colors.jpg" class="img-responsive" alt="Image 6">
                        <div class="gallery-box-caption">
                            <div class="gallery-box-content">
                                <div>
                                    <i class="icon-lg ion-ios-search"></i>
